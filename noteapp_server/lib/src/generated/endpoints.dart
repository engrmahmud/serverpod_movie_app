...
import '../endpoints/movie_endpoints.dart' as _i4;
import '../greetings/greeting_endpoint.dart' as _i5;
import 'package:noteapp_server/src/generated/movie.dart' as _i6;
        ...
        'retrieve': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['movie'] as _i4.MovieEndpoint).retrieve(
                session,
                params['id'],
              ),
        ),
        'create': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['movie'] as _i4.MovieEndpoint).create(
                session,
                params['movie'],
              ),
        ),
